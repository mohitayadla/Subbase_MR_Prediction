...
# Input fields
layer_thickness = st.number_input("Layer Thickness  (inches)", min_value=0.0, value=150.0, step=10.0, help="Enter the thickness of the base layer")
...
aashto_encoding = {
    "A-1-a": 502, "A-1-b": 503, "A-2-4": 506,  
    "A-2-6": 508, "A-2-7": 509, "A-3": 504, "A-4": 510, 
    "A-5": 511, "A-6": 512,  "A-7-6": 515
}
