...
# Input fields
layer_thickness = st.number_input("Layer Thickness (mm)", min_value=0.0, value=150.0, step=10.0, help="Enter the thickness of the subbase layer")
...
max_lab_dry_density = st.number_input("Maximum Lab Dry Density (kg/m³)", min_value=1000.0, max_value=3000.0, value=2000.0, step=10.0, help="Maximum dry density from laboratory compaction test")
